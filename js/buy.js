...
const Cards = (product) => {
  ...
  div_card.setAttribute("data-car", product.idproducts);
  div_card.className = "card";
  div_card.style.width = "18rem";

  const title = document.createElement("H5");
  title.className = "text-center mt-3 card-title";
  ...
  paragraph_value.className = "card-text text-center card-amount";
  ...
  const button_buy = document.createElement("BUTTON");
    button_buy.className = "carrito-button btn btn-success";
    button_buy.style = "margin-left:85px"
    button_buy.textContent ="Adquirir";
